define(["exports"], function (t) {
  ...
  class H {
    constructor(t, e = {}) {
      (this.N = !1), (this.O = !1), (this.T = e.maxEntries), (this.k = e.maxAgeSeconds), (this.B = e.matchOptions), (this._ = t), (this.P = new F(t));
    }
    async expireEntries() {
  ...
  class Z extends v {
    constructor(t = {}) {
      (t.cacheName = w(t.cacheName)), super(t), (this.W = !1 !== t.fallbackToNetwork), this.plugins.push(Z.copyRedirectedCacheableResponsesPlugin);
    }
    async D(t, e) {

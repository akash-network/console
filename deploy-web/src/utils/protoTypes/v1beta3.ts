...
import { DecCoin } from "./deccoin-v3";
export { MsgUpdateProvider } from "../proto/akash/v1beta3";
...
const ResourceUnits = new Type("ResourceUnits")
  ...
  .add(Storage)
  .add(new Field("gpu", 4, "GPU"))
  .add(GPU)
  .add(new Field("endpoints", 5, "Endpoint", "repeated"))
  .add(Endpoint);

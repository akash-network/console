...
import { GranterRow } from "@src/app/settings/authorizations/GranterRow";
import { GranteeRow } from "@src/app/settings/authorizations/GranteeRow";
import { AllowanceModal } from "@src/app/settings/authorizations/AllowanceModal";
import { AllowanceIssuedRow } from "@src/app/settings/authorizations/AllowanceIssuedRow";
import { averageBlockTime } from "@src/utils/priceUtils";
import { AllowanceGrantedRow } from "@src/app/settings/authorizations/AllowanceGrantedRow";
...
export const Authorizations: React.FunctionComponent<Props> = ({}) => {
  ...
  return (
    <PageContainer isLoading={!!isRefreshing || isLoadingAllowancesIssued || isLoadingAllowancesGranted || isLoadingGranteeGrants || isLoadingGranterGrants}>
      <SettingsLayout

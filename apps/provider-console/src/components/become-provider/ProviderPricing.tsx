  ...
  return (
    <div className="flex w-full flex-col items-center pt-10">
      <div className="w-full max-w-5xl space-y-6">
        ...
        <Form {...form} onSubmit={form.handleSubmit(submit)} className="space-y-6">
            ...
            <div className="col-span-2 space-y-6">
              ...
              <div className="bg-secondary rounded-lg p-6">
                ...
                <p className="text-muted-foreground mb-4 text-sm">
                  See how other providers price similar resources on the Akash Network. Use this information to set competitive rates and maximize your monthly
                  earnings.
                </p>
                <div>

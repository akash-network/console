...
import { Alert, AlertDescription, Button, Card, CardContent, CardHeader, CardTitle, Checkbox, Input, Progress } from "@akashnetwork/ui/components";
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-3">
            <div className="flex items-center">
              <div className="mr-2 h-6 w-6 text-green-600 dark:text-green-400">🏠</div>
              <h1 className="text-lg font-semibold text-gray-900 dark:text-white">Akash HomeNode</h1>
            </div>
            <div className="flex items-center space-x-3">
              <div className="flex items-center space-x-2">
                <span className="text-sm text-gray-600 dark:text-gray-300">wallet info</span>
                <div className="rounded bg-gray-100 px-2 py-1 text-sm text-gray-700 dark:bg-gray-700 dark:text-gray-200">$20.00</div>
                ...
                <CardContent className="pt-0 text-center">
                  ...
                  <Alert className="mb-4 border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20">
                    ...
                    <AlertDescription className="text-sm text-red-800 dark:text-red-200">
                      <strong>Warning:</strong> Installing this file on your device will permanently erase all of its contents. This action cannot be undone.
                    </AlertDescription>
                  </Alert>
              ...
              <Card className="shadow-sm">
                ...
                <CardContent className="pt-0 text-center">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="token" className="mb-1 block text-sm font-medium text-gray-900 dark:text-white">
                        Token
                      </label>
                      <div className="flex justify-center">
                        <Input id="token" value={generatedToken} placeholder="Your token will appear here" readOnly className="rounded-r-none text-sm" />
                        <Button variant="outline" size="sm" className="rounded-l-none border-l-0" onClick={() => navigator.clipboard.writeText(generatedToken)}>
                          📋
                        </Button>
                      </div>
                    </div>
                    <Button onClick={handleGenerateToken} className="bg-black py-2 text-sm text-white hover:bg-gray-800" size="sm">
                      <span className="mr-2">⭐</span>
                      Create token
                    </Button>
                  </div>

...
export class ApiUrlService {
  ...
  static mainnetNodes() {
    return `${browserEnvConfig.NEXT_PUBLIC_CONSOLE_API_URL}/v1/nodes/mainnet`;
  }
  static testnetNodes() {
    return `${browserEnvConfig.NEXT_PUBLIC_CONSOLE_API_URL}/v1/nodes/testnet`;
  }
  static sandboxNodes() {
  ...
  static blocks(limit: number) {
    return `${browserEnvConfig.NEXT_PUBLIC_CONSOLE_API_URL}/v1/blocks${appendSearchParams({ limit })}`;
  }

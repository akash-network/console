          ...
          <TableBody>
            {redelegations.map(redelegation => (
              <TableRow key={`${redelegation.srcAddress.operatorAddress}_${redelegation.dstAddress.operatorAddress}`}>
                <TableCell>
                  <Link to={UrlService.validator(redelegation.srcAddress.operatorAddress)}>{getShortText(redelegation.srcAddress.moniker, 20)}</Link>
                </TableCell>
                <TableCell>
                  <Link to={UrlService.validator(redelegation.dstAddress.operatorAddress)}>{getShortText(redelegation.dstAddress.moniker, 20)}</Link>
                </TableCell>

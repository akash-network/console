...
import { envConfig } from "@src/billing/config/env.config";
import { env } from "./env";
...
export const apiNodeUrl = envConfig.REST_API_NODE_URL ?? netConfig.getBaseAPIUrl(env.NETWORK as SupportedChainNetworks) ?? netConfig.getBaseAPIUrl("mainnet");

  ...
  async getProviderDashboard(owner: string): Promise<ProviderDashboardResponse> {
    ...
    return {
      current: {
        ...
        totalUUsdcEarned: currentTotalEarnings.uact,
        dailyUUsdcEarned: currentTotalEarnings.uact - previousTotalEarnings.uact,
        totalUActEarned: currentTotalEarnings.uact,
        dailyUActEarned: currentTotalEarnings.uact - previousTotalEarnings.uact,
      ...
      previous: {
        ...
        totalUUsdcEarned: previousTotalEarnings.uact,
        dailyUUsdcEarned: previousTotalEarnings.uact - secondPreviousTotalEarnings.uact,
        totalUActEarned: previousTotalEarnings.uact,
        dailyUActEarned: previousTotalEarnings.uact - secondPreviousTotalEarnings.uact,

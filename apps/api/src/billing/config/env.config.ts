...
export const envSchema = z.object({
  ...
  /**
   * Must stay above the signer's own `SIGN_AND_BROADCAST_DEADLINE_MS`, or aborting here abandons a transaction the
   * signer is still broadcasting and its outcome becomes unknowable again.
   */

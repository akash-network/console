...
export const envSchema = z.object({
  ...
  REVIEW_TRIAL_DEPLOYMENT_ALLOWANCE_AMOUNT: z.number({ coerce: true }).default(10_000_000),
  REVIEW_TRIAL_FEES_ALLOWANCE_AMOUNT: z.number({ coerce: true }).default(500_000),

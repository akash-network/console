...
export const createProviderSnapshotNode = async (overrides: Partial<CreationAttributes<ProviderSnapshotNode>> = {}): Promise<ProviderSnapshotNode> => {
  return await ProviderSnapshotNode.create({

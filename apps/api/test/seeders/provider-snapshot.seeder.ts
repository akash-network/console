...
export class ProviderSnapshotSeeder {
  static create(overrides: Partial<CreationAttributes<ProviderSnapshot>> = {}): CreationAttributes<ProviderSnapshot> {
    return {
  ...
  static async createInDatabase(overrides: Partial<CreationAttributes<ProviderSnapshot>> = {}): Promise<ProviderSnapshot> {
    const seed = ProviderSnapshotSeeder.create(overrides);
    return await ProviderSnapshot.create(seed);
  }
}

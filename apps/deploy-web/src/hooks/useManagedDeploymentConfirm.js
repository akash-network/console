...
var useManagedDeploymentConfirm = function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, confirm({
                            title: "Are you sure you want to close ".concat(dseq.length > 1 ? "these deployments" : "this deployment", "?"),
    ...
    return { closeDeploymentConfirm: closeDeploymentConfirm };
};
exports.useManagedDeploymentConfirm = useManagedDeploymentConfirm;

...
export const browserEnvConfig = validateStaticEnvVars({
  ...
  NEXT_PUBLIC_LINKEDIN_TRACKING_ENABLED: process.env.NEXT_PUBLIC_LINKEDIN_TRACKING_ENABLED,
  NEXT_PUBLIC_GROWTH_CHANNEL_TRACKING_ENABLED: process.env.NEXT_PUBLIC_GROWTH_CHANNEL_TRACKING_ENABLED,
  NEXT_PUBLIC_NOTIFICATIONS_API_BASE_URL: process.env.NEXT_PUBLIC_NOTIFICATIONS_API_BASE_URL,

...
export const browserEnvConfig = validateStaticEnvVars({
  ...
  NEXT_PUBLIC_PROVIDER_PROXY_MAINNET_URL: process.env.NEXT_PUBLIC_PROVIDER_PROXY_MAINNET_URL,
  NEXT_PUBLIC_PROVIDER_PROXY_TESTNET_URL: process.env.NEXT_PUBLIC_PROVIDER_PROXY_TESTNET_URL,
  NEXT_PUBLIC_PROVIDER_PROXY_SANDBOX_URL: process.env.NEXT_PUBLIC_PROVIDER_PROXY_SANDBOX_URL,

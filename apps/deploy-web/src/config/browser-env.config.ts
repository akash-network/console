...
export const browserEnvConfig = validateStaticEnvVars({
  ...
  NEXT_PUBLIC_AKASH_SANDBOX_CHAIN_ID: process.env.NEXT_PUBLIC_AKASH_SANDBOX_CHAIN_ID,
  NEXT_PUBLIC_AKASH_SANDBOX_RPC_URL: process.env.NEXT_PUBLIC_AKASH_SANDBOX_RPC_URL,
  NEXT_PUBLIC_AKASH_SANDBOX_REST_API_URL: process.env.NEXT_PUBLIC_AKASH_SANDBOX_REST_API_URL,
  NEXT_PUBLIC_AKASH_SANDBOX_GENESIS_URL: process.env.NEXT_PUBLIC_AKASH_SANDBOX_GENESIS_URL,
  ...
  NEXT_PUBLIC_AMPLITUDE_PROXY_URL: process.env.NEXT_PUBLIC_AMPLITUDE_PROXY_URL,
  ...
  NEXT_PUBLIC_MANAGED_WALLET_TRIAL_BLOCKED_GPU_MODELS: process.env.NEXT_PUBLIC_MANAGED_WALLET_TRIAL_BLOCKED_GPU_MODELS,
  NEXT_PUBLIC_CONTACT_SUPPORT_URL: process.env.NEXT_PUBLIC_CONTACT_SUPPORT_URL
});

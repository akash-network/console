...
export const browserEnvSchema = z.object({
  ...
  NEXT_PUBLIC_AKASH_SANDBOX_CHAIN_ID: z.string().trim().min(1).optional(),
  NEXT_PUBLIC_AKASH_SANDBOX_RPC_URL: z.string().url().optional(),
  NEXT_PUBLIC_AKASH_SANDBOX_REST_API_URL: z.string().url().optional(),
  NEXT_PUBLIC_AKASH_SANDBOX_GENESIS_URL: z.string().url().optional(),

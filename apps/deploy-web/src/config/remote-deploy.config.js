...
exports.supportedFrameworks = exports.REDIRECT_URL = exports.protectedEnvironmentVariables = exports.ROOT_FOLDER_NAME = exports.DEFAULT_ENV_IN_YML = exports.CURRENT_SERVICE = exports.CI_CD_TEMPLATE_ID = void 0;
var browser_env_config_1 = require("./browser-env.config");
exports.CI_CD_TEMPLATE_ID = "akash-network-awesome-akash-automatic-deployment-CICD-template";
exports.CURRENT_SERVICE = "services.0.env";
exports.DEFAULT_ENV_IN_YML = "https://github.com/onwidget/astrowind";
exports.ROOT_FOLDER_NAME = "akash-root-folder-repo-path";
exports.protectedEnvironmentVariables = {
    REPO_URL: "REPO_URL",
...
exports.REDIRECT_URL = "".concat(browser_env_config_1.browserEnvConfig.NEXT_PUBLIC_REDIRECT_URI, "?step=edit-deployment&type=github");

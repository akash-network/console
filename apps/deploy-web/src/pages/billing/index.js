...
var BillingPage_1 = require("@src/components/billing-usage/BillingPage");
var WalletProvider_1 = require("@src/context/WalletProvider");
var guard_hoc_1 = require("@src/hoc/guard/guard.hoc");
...
exports.default = (0, guard_hoc_1.Guard)(BillingPage_1.BillingPage, (0, guard_hoc_1.composeGuards)(WalletProvider_1.useIsManagedWalletUser, useUser_1.useIsRegisteredUser));
    ...
    if: function (ctx) { return __awaiter(void 0, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, pageGuards_1.isFeatureEnabled)("billing_usage", ctx)];
            case 2:
                _a = (_b.sent());
                _b.label = 3;

...
function TermsOfService() {
    return (<Layout_1.default>
      <CustomNextSeo_1.CustomNextSeo title="Terms of service" url={"".concat(urlUtils_1.domainName).concat(urlUtils_1.UrlService.termsOfService())} description="Akash Console webiste terms of service."/>

      <div className="mx-auto max-w-4xl p-8 leading-relaxed">
        <Title_1.Title>Akash Network Terms of Service</Title_1.Title>
        ...
        <p className="mb-4">
          ...
          <link_1.default href="mailto:consolebilling@akash.network" target="_blank" rel="noopener noreferrer">
        ...
        <p className="mb-4">
          ...
          <link_1.default href="https://iccwbo.org/dispute-resolution/dispute-resolution-services/arbitration/rules-procedure/2021-arbitration-rules/" target="_blank" rel="noopener noreferrer">
            here
          </link_1.default>
        ...
        <p className="mb-4">
          ...
          <link_1.default href={urlUtils_1.UrlService.privacyPolicy()}>Privacy Policy</link_1.default>.
        </p>

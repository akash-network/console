...
import { parseManifestServices } from "./placementModel";
...
export const DeploymentPlacements: FC<DeploymentPlacementsProps> = ({ leases, providers, deploymentManifest, dseq, onClosed, dependencies: d = DEPENDENCIES }) => {

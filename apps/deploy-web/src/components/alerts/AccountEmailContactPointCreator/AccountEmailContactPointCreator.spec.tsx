...
import { AccountEmailContactPointCreateTrigger } from "./AccountEmailContactPointCreator";

import { fireEvent, render, screen } from "@testing-library/react";

describe("AccountEmailContactPointCreateTrigger", () => {
  ...
  function setup(props = {}) {
    ...
    const utils = render(<AccountEmailContactPointCreateTrigger {...defaultProps} testId={testId} />);

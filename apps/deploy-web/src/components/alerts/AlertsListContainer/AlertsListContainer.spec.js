...
describe(AlertsListContainer_1.AlertsListContainer.name, function () {
    it("renders alerts list with data", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("calls delete endpoint and shows success notification when alert removal succeeds", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, react_2.waitFor)(function () {
                            expect(requestFn).toHaveBeenCalledWith(expect.objectContaining({ method: "delete", url: "/v1/alerts/{id}" }), expect.objectContaining({ baseUrl: "", body: undefined, parameters: { path: { id: mockData.data[0].id } } }));
                            expect(react_2.screen.getByTestId("alert-remove-success-notification")).toBeInTheDocument();
                        })];
                case 3:
                    _b.sent();
                    return [2 /*return*/];
    ...
    it("calls delete endpoint and shows error notification when alert removal fails", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, mockData, requestFn, child;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, setup()];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, react_2.waitFor)(function () {
                            expect(requestFn).toHaveBeenCalledWith(expect.objectContaining({ method: "delete", url: "/v1/alerts/{id}" }), expect.objectContaining({ baseUrl: "", body: undefined, parameters: { path: { id: mockData.data[0].id } } }));
                            expect(react_2.screen.getByTestId("alert-remove-error-notification")).toBeInTheDocument();
                        })];
                case 3:
                    _b.sent();
                    return [2 /*return*/];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, react_2.waitFor)(function () {
                            expect(requestFn).toHaveBeenCalledWith(expect.objectContaining({ method: "get", url: "/v1/alerts" }), expect.objectContaining({
                                parameters: {
                                    query: {
                                        page: 2,
                                        limit: 10
    ...
    function setup() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockData = {
                            data: Array.from({ length: 11 }, function () { return (0, alert_1.buildAlert)({ type: faker_1.faker.helpers.arrayElement(["DEPLOYMENT_BALANCE", "CHAIN_MESSAGE"]), deploymentName: "NA" }); }),
                            pagination: {
                                page: 1,
                                limit: 10,
                                total: 11,
        ...
        <ServicesProvider_1.ServicesProvider services={services}>
          <react_query_1.QueryClientProvider client={queries_1.queryClient}>
            <LocalNoteProvider_1.LocalNoteProvider>
              <AlertsListContainer_1.AlertsListContainer>{childCapturer.renderChild}</AlertsListContainer_1.AlertsListContainer>
            </LocalNoteProvider_1.LocalNoteProvider>

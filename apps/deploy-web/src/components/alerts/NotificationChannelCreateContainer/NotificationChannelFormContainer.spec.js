...
describe("NotificationChannelCreateContainer", function () {
    it("triggers a notification channel creation with the correct values", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, react_2.waitFor)(function () {
                            ...
                            expect(react_2.screen.getByTestId("notification-channel-create-success-notification")).toBeInTheDocument();
                        })];
                case 2:
                    _b.sent();
                    return [2 /*return*/];
    ...
    it("triggers a notification channel creation and shows error message on error", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, requestFn, input, child;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, setup()];
                case 1:
                    ...
                    return [4 /*yield*/, (0, react_2.waitFor)(function () {
                            ...
                            expect(react_2.screen.getByTestId("notification-channel-create-error-notification")).toBeInTheDocument();
                        })];
                case 2:
                    _b.sent();
                    return [2 /*return*/];
    ...
    function setup() {
        ...
        <ServicesProvider_1.ServicesProvider services={services}>
          <react_query_1.QueryClientProvider client={queries_1.queryClient}>
            <NotificationChannelCreateContainer_1.NotificationChannelCreateContainer onCreate={jest.fn()}>{childCapturer.renderChild}</NotificationChannelCreateContainer_1.NotificationChannelCreateContainer>

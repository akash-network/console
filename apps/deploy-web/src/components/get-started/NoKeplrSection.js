...
var NoKeplrSection = function () {
    ...
    return (<div>
      ...
      <ul className="list-decimal space-y-2 py-4 pl-8">
        ...
        <li>
          Use <ExternalLink_1.ExternalLink href="https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn" text="MetaMask"/> wallet to import USDC
          to <ExternalLink_1.ExternalLink href="https://app.osmosis.zone/assets" text="Osmosis"/>
        </li>
...
exports.NoKeplrSection = NoKeplrSection;

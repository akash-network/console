...
var formSchema = zod_2.z.object({
    amount: zod_2.z.coerce.number().min(0, {
...
var AllowanceModal = function (_a) {
    var _b;
    var editingAllowance = _a.editingAllowance, address = _a.address, onClose = _a.onClose;
    var formRef = (0, react_1.useRef)(null);
    var _c = (0, react_1.useState)(""), error = _c[0], setError = _c[1];
    var signAndBroadcastTx = (0, WalletProvider_1.useWallet)().signAndBroadcastTx;
    var form = (0, react_hook_form_1.useForm)({
        defaultValues: {
            amount: editingAllowance ? (0, priceUtils_1.coinToDenom)(editingAllowance.allowance.spend_limit[0]) : 0,
            expiration: (0, date_fns_1.format)((0, date_fns_1.addYears)(new Date(), 1), "yyyy-MM-dd'T'HH:mm"),
            granteeAddress: (_b = editingAllowance === null || editingAllowance === void 0 ? void 0 : editingAllowance.grantee) !== null && _b !== void 0 ? _b : ""
        },
    ...
    var _d = watch(), amount = _d.amount, granteeAddress = _d.granteeAddress, expiration = _d.expiration;
    var denomData = (0, useWalletBalance_1.useDenomData)(denom_config_1.UAKT_DENOM);
    ...
    var onSubmit = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var messages, spendLimit, expirationDate, response;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    clearErrors();
                    messages = [];
                    spendLimit = (0, priceUtils_1.aktToUakt)(amount);
                    expirationDate = new Date(expiration);
                    if (editingAllowance) {
                        messages.push(TransactionMessageData_1.TransactionMessageData.getRevokeAllowanceMsg(address, granteeAddress));
                    }
                    messages.push(TransactionMessageData_1.TransactionMessageData.getGrantBasicAllowanceMsg(address, granteeAddress, spendLimit, denom_config_1.UAKT_DENOM, expirationDate));
    ...
    return (<components_1.Popup fullWidth open variant="custom" actions={[
        ...
        ]} onClose={onClose} maxWidth="sm" enableCloseOnBackdropClick title="Authorize Fee Spending">
      <components_1.Form {...form}>
        <form onSubmit={handleSubmit(onSubmit)} ref={formRef}>
          <components_1.Alert className="mb-4">
            <p className="text-sm text-muted-foreground">
              <LinkTo_1.LinkTo onClick={function (ev) { return handleDocClick(ev, "https://docs.cosmos.network/v0.46/modules/feegrant/"); }}>Authorized Fee Spend</LinkTo_1.LinkTo> allows users to
          ...
          <div className="mb-4 w-full">
            ...
            var field = _a.field;
            return (<components_1.FormInput {...field} type="number" label="Spending Limit" autoFocus min={0} step={0.000001} max={denomData === null || denomData === void 0 ? void 0 : denomData.max} startIcon={<span className="pl-2 text-xs">{denomData === null || denomData === void 0 ? void 0 : denomData.label}</span>}/>);
        }}/>
          </div>
          ...
          <div className="mb-4 w-full">
            ...
            var field = _a.field;
            return <components_1.FormInput {...field} type="text" label="Grantee Address" disabled={!!editingAllowance}/>;
        }}/>
          </div>
...
exports.AllowanceModal = AllowanceModal;

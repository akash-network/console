...
exports.MemoryFormControl = void 0;
...
var MemoryFormControl = function (_a) {
    var control = _a.control, serviceIndex = _a.serviceIndex;
    return (<components_1.FormField control={control} name={"services.".concat(serviceIndex, ".profile.ram")} render={function (_a) {
            var field = _a.field, fieldState = _a.fieldState;
            return (<FormPaper_1.FormPaper>
          <components_1.FormItem>
            <div className="flex flex-col items-start lg:flex-row lg:items-center">
              <div className="flex items-center">
                <md_1.MdMemory className="mr-2 text-2xl text-muted-foreground"/>
              ...
              <div className="mt-2 flex items-center lg:ml-4 lg:mt-0">
                <components_1.Input type="number" error={!!fieldState.error} color="secondary" value={field.value || ""} onChange={function (event) { return field.onChange(parseFloat(event.target.value)); }} min={1} step={1} inputClassName="w-[100px]"/>

                <react_hook_form_1.Controller control={control} name={"services.".concat(serviceIndex, ".profile.ramUnit")} defaultValue="" render={function (_a) {
                    var _b;
                    var field = _a.field;
                    return (<components_1.Select value={((_b = field.value) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || ""} onValueChange={field.onChange}>
                      ...
                      <components_1.SelectContent>
                        <components_1.SelectGroup>
                          {units_1.memoryUnits.map(function (t) {
            ...
            <components_1.Slider value={[field.value || 0]} min={1} max={5120} step={1} color="secondary" aria-label="RAM" onValueChange={function (newValue) { return field.onChange(newValue[0]); }} className="pt-2"/>
...
exports.MemoryFormControl = MemoryFormControl;

...
export const BillingContainer: React.FC<BillingContainerProps> = ({ children }) => {
  ...
  const {
    ...
    created: {
      gt: from ? Math.floor(from.getTime() / 1000) : undefined,
      lt: to ? Math.floor(to.getTime() / 1000) : undefined
    }
  });

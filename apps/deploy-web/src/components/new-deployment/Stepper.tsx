          ...
          <li key={step.name} className="relative md:flex md:flex-1">
            {step.id < activeStep ? (
              ...
              <div className="flex items-center px-6 py-4 text-sm font-medium" aria-current="step">
                <span className="border-primary flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border-2">
              ...
              <div className="group flex items-center">
                <span className="flex items-center px-6 py-4 text-sm font-medium">
                  <span className="border-muted-foreground/20 group-hover:border-muted-foreground/30 dark:group-hover:border-muted-foreground/20 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border-2">

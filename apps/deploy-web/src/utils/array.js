...
exports.createFilterUnique = createFilterUnique;
exports.forEachGeneratedItem = forEachGeneratedItem;
function createFilterUnique(matcher) {
    if (matcher === void 0) { matcher = function (a, b) { return a === b; }; }
    return function (value, index, array) {
        return array.findIndex(function (other) { return matcher(value, other); }) === index;
    };
}
function forEachGeneratedItem(generator, onNext) {

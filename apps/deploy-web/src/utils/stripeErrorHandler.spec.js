...
var stripeErrorHandler_1 = require("./stripeErrorHandler");
describe("StripeErrorHandler", function () {
    describe("handleStripeError", function () {
        it("should handle 402 payment declined errors", function () {
            var error = {
                response: {
                    status: 402
                }
            };
            var result = (0, stripeErrorHandler_1.handleStripeError)(error);
        ...
        it("should handle 400 bad request errors", function () {
            var error = {
                response: {
                    status: 400
                }
        ...
        it("should handle 502/503 service unavailable errors", function () {
            var error = {
                response: {
                    status: 502
                }
        ...
        it("should handle 409 idempotency errors", function () {
            var error = {
                response: {
                    status: 409
                }
        ...
        it("should handle insufficient funds error codes", function () {
            var error = {
                response: {
                    status: 402,
                    data: {
        ...
        it("should handle card expired error codes", function () {
            var error = {
                response: {
                    status: 402,
                    data: {
        ...
        it("should handle card declined error codes", function () {
            var error = {
                response: {
                    status: 402,
                    data: {
        ...
        it("should handle minimum payment amount error codes", function () {
            var error = {
                response: {
                    status: 400,
                    data: {
        ...
        it("should handle final amount too low error codes", function () {
            var error = {
                response: {
                    status: 400,
                    data: {
        ...
        it("should handle payment method not owned error codes", function () {
            var error = {
                response: {
                    status: 403,
                    data: {
        ...
        it("should handle unknown error codes gracefully", function () {
            var error = {
                response: {
                    status: 500,
                    data: {
        ...
        it("should handle errors without response structure", function () {
            var error = {};
            var result = (0, stripeErrorHandler_1.handleStripeError)(error);
            expect(result.message).toBe("An unexpected error occurred. Please try again.");
            expect(result.userAction).toBe("Try again or contact support if the problem persists.");
        });
        it("should handle errors with message but no response structure", function () {
            var error = {
    ...
    describe("handleCouponError", function () {
        it("should handle invalid coupon code error codes", function () {
            var response = {
                error: {
            ...
            var result = (0, stripeErrorHandler_1.handleCouponError)(response);
        ...
        it("should handle coupon expired error codes", function () {
            var response = {
                error: {
        ...
        it("should handle coupon already used error codes", function () {
            var response = {
                error: {
        ...
        it("should handle coupon not applicable error codes", function () {
            var response = {
                error: {
        ...
        it("should handle unknown coupon error codes gracefully", function () {
            var response = {
                error: {
        ...
        it("should handle coupon errors without code", function () {
            var response = {
                error: {
                    message: "Custom error message"
                }
        ...
        it("should handle response without error", function () {
            var response = {};
            var result = (0, stripeErrorHandler_1.handleCouponError)(response);

...
exports.handleCouponError = handleCouponError;
/**
...
function handleStripeError(error) {
    ...
    if (error && typeof error === "object" && "response" in error && error.response && typeof error.response === "object" && "status" in error.response) {
        ...
        return handleErrorByStatus(status_1, errorData === null || errorData === void 0 ? void 0 : errorData.message);
    }
 ...
 */
function handleErrorByCode(errorCode, originalMessage) {
    var errorHandlers = {
 ...
 */
function handleErrorByStatus(status, originalMessage) {
    switch (status) {
        case 402:
            return {

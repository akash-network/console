define(["exports"], function (t) {
  ...
  class H {
    constructor(t, e = {}) {
      (this.O = !1), (this.T = !1), (this.k = e.maxEntries), (this.B = e.maxAgeSeconds), (this.P = e.matchOptions), (this.L = t), (this.M = new F(t));
    }
    async expireEntries() {
  ...
  class Z extends v {
    constructor(t = {}) {
      (t.cacheName = w(t.cacheName)), super(t), (this.j = !1 !== t.fallbackToNetwork), this.plugins.push(Z.copyRedirectedCacheableResponsesPlugin);
    }
    async U(t, e) {
...
//# sourceMappingURL=workbox-495fd258.js.map

!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "6c32dc39-04c5-4b3f-8c26-c6c727223e99"),
      (e._sentryDebugIdIdentifier = "sentry-dbid-6c32dc39-04c5-4b3f-8c26-c6c727223e99"));
  } catch (e) {}
})();
      ...
      a.a(e, async function (e, l) {
        try {
          ...
          function D() {
            ...
            let D = (0, b.useMemo)(() => (0, N.k)(C.name), [C.name]),
              [U, M] = (0, b.useState)(!1),
              [R, B] = (0, b.useState)(""),
              [H, K] = (0, b.useState)(),
              [G, L] = (0, b.useState)(""),
              [O, W] = (0, b.useState)("movement"),
              [z, V] = (0, b.useState)(),
              Y = (0, j.s0)(),
              [P, Q] = (0, b.useState)(""),
              Z = (0, x.a7)(),
            ...
            (0, b.useEffect)(() => {
              T()
                ...
                .then(async function (e) {
                  let { chainId: t, existingChainId: a, origin: l } = e[f.AI].payload;
                  L(t), B(a), Q(l);
                });
            }, []),
              (0, b.useEffect)(() => {
            ...
            let ee = async () => {
              ...
              et = async () => {
                var e, t, a, l, i, s, n, c;
                if (!O) return;
                M(!0), await (0, p.E)([G], [C.id], P);
                let r = (0, m.DY)(P, "aptos-");
                ...
                children: (0, i.jsxs)(d.Z, {
                  header: (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsx)(n.Header, {
                      ...
                      title: (0, i.jsx)(n.Buttons.Wallet, { title: (0, _.fy)(D, 10), className: "pr-4 cursor-default" })
                    })
                  }),
                  children: [
                    (0, i.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, i.jsx)("div", {
                              ...
                              children: (0, i.jsx)("div", {
                                ...
                                children: (0, i.jsx)(c.o, { size: 16, className: "dark:text-white-100 text-black-100" })
                              })
                            }),
                            (0, i.jsx)(A.H, {
                      ...
                      children: (0, i.jsxs)("div", {
                        ...
                        children: [
                          (0, i.jsx)(n.Buttons.Generic, {
                            ...
                            onClick: ee,
                            disabled: U,
                            "aria-label": "switch chain reject button",
                            children: "Reject"
                          }),
                          (0, i.jsx)(n.Buttons.Generic, {
                            ...
                            "aria-label": "switch chain button",
                            children: U ? (0, i.jsx)(u.T, { color: "white" }) : "Switch chain"
                          })
                        ]
                      })
                    })

!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "e5d80584-9d86-421c-ae8c-4103b86baf84"),
      (e._sentryDebugIdIdentifier = "sentry-dbid-e5d80584-9d86-421c-ae8c-4103b86baf84"));
  } catch (e) {}
})();
    ...
    21886: function (e, t, a) {
      ...
      var c = Object.defineProperty,
        ...
        b = (e, t) => {
          ...
          if (f) for (var a of f(t)) p.call(t, a) && h(e, a, t[a]);
          return e;
        },
        x = (e, t) => m(e, u(t));
        ...
        return (
          (0, s.useEffect)(() => {
            ...
            if (t && a && d) {
              ...
              try {
                _().track(j.B_.OnboardingCompleted, {
                  methodChosen: l,
                  timeTaken1: N()(e).diff(t, "seconds"),
                  timeTaken2: N()(e).diff(a, "seconds"),
                  wallet: n,
                  time: Date.now() / 1e3
                });
              } catch (e) {
          ...
          (0, l.jsxs)(l.Fragment, {
            children: [
              (0, k.createPortal)((0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(z, {}), (0, l.jsx)(T, {})] }), document.body),
              (0, l.jsxs)(V.z, {
                hideRightActions: !0,
      ...
      let z = () =>
        ...
        P = { show: { opacity: 1, y: 0 }, hide: { opacity: 0, y: -10 } },
        T = () => {

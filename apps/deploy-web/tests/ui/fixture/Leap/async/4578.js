!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "fc879589-723d-4455-89c1-9c4a8dd8060c"),
      (e._sentryDebugIdIdentifier = "sentry-dbid-fc879589-723d-4455-89c1-9c4a8dd8060c"));
  } catch (e) {}
})();
  ...
  ["4578"],
  {
            ...
            return (0, o.useCallback)(
              async (r, s) => {
                ...
                let o = await e(),
                  ...
                  x = null == p ? void 0 : p[r],
                  g = x ? (0, i.pe)(x, c.M8.password) : null,
                  h = [...(g ? JSON.parse(g) : { contracts: [] }).contracts];
                h.includes(s) || h.push(s);
                let f = await d.createQueryPermit(r, "permit", h, ["balance", "history"]),
                  y = e => {
                    if (!c.M8.password) throw Error("Password not set");
                    return { [r]: e ? (0, i.HI)(JSON.stringify({ contracts: h, permit: f }), c.M8.password) : { contracts: h, permit: f } };
                  };
                return t(y(!1)), await u().storage.local.set({ [m.J$]: y(!0) }), f;
              },
              [n, e, a, t]
            );
          }
      ...
      a.a(e, async function (e, n) {
        try {
          ...
          async function g(e, t, a, n) {
            let r = l.tgY.create(e, l.oCA.secret.chainId, n);
            return !!(await r.getBalance(n, a, t)).balance;
          }
          function h() {
            let e = (0, p.E)(),
              t = (0, r.VMC)(),
              a = r.rNU.useOperateCosmosTx(),
              { setViewingKeys: n } = (0, r.WdY)();
            return (0, o.useCallback)(
              async (o, d, p, x, h, f) => {
                if (!c.M8.password) throw Error("Password not set");
                let y = await e(),
                  v = l.KQf.create(o ?? "", d, y),
                  b = null == f ? void 0 : f.key;
                if (h) {
                  if (!(await g(o ?? "", b ?? "", x, p))) return { validKey: !1, error: "Invalid viewing key", key: b };
                } else
                  try {
                    var w, j, k, C, H;
                    let { txStatus: e, viewingKey: n } = await v.createViewingKey(p, x, t, {
                      key: b,
                    ...
                    a({
                      ...
                      feeQuantity:
                        (null === (H = e.tx) || void 0 === H
                          ? void 0
                          : null === (C = H.auth_info) || void 0 === C
                            ? void 0
                            : null === (k = C.fee) || void 0 === k
                              ? void 0
                              : null === (j = k.amount) || void 0 === j
                                ? void 0
                                : null === (w = j[0]) || void 0 === w
                                  ? void 0
                                  : w.amount) ?? "0.01",
                    ...
                    return (
                      (0, s.Tb)(e, {
                        ...
                        extra: { lcdUrl: o, chainId: d, signerAddress: p, contractAddress: x }
                      }),
                      { validKey: !1, error: "Unable to create viewing key" }
                    );
                  }
                let Z = (0, i.HI)(b, c.M8.password),
                  E = (await u().storage.local.get([m.rg]))[m.rg];
                if (E) {
                  let e = e => ({ ...E, [p]: { ...E[p], [x]: e ? Z : b } });
                  await u().storage.local.set({ [m.rg]: e(!0) }), n(e(!1));
                } else {
                  let e = e => ({ [p]: { [x]: e ? Z : b } });
                  await u().storage.local.set({ [m.rg]: e(!0) }), n(e(!1));
                }
    ...
    31123: function (e, t, a) {
      ...
      var d = Object.defineProperty,
        ...
        h = (e, t, a) => (t in e ? d(e, t, { enumerable: !0, configurable: !0, writable: !0, value: a }) : (e[t] = a)),
        f = (e, t) => {
          for (var a in t || (t = {})) x.call(t, a) && h(e, a, t[a]);
          if (p) for (var a of p(t)) g.call(t, a) && h(e, a, t[a]);
          return e;
        },
        y = (e, t) => u(e, m(t));
      let v = (0, s.forwardRef)((e, t) => s.createElement(o.Z, y(f({ ref: t }, e), { weights: c })));
      v.displayName = "PencilSimple";
      let b = new Map([
        [
          "bold",
          s.createElement(
      ...
      var w = Object.defineProperty,
        ...
        N = (e, t) => {
          for (var a in t || (t = {})) H.call(t, a) && E(e, a, t[a]);
          if (C) for (var a of C(t)) Z.call(t, a) && E(e, a, t[a]);
          return e;
        },
        A = (e, t) => j(e, k(t));
      let V = (0, s.forwardRef)((e, t) => s.createElement(o.Z, A(N({ ref: t }, e), { weights: b })));
        ...
        return (0, n.jsxs)("div", {
          children: [
            ...
            (0, n.jsx)("div", {
              ...
              children: (0, n.jsx)(s.Z, { size: "md", className: "text-center font-bold", children: (0, r.MDB)(e.generatedViewingKey ?? "") })
            }),
            (0, n.jsx)(l.Buttons.CopyToClipboard, { color: o.w.getChainColor(t), onCopy: e.onCopy })
          ]
        });
      }
    },
        ...
        try {
          ...
          function j(e) {
            let { isVisible: t, onClose: a, token: n, onSuccess: w } = e,
              j = (0, p.a)(),
              [k, C] = (0, x.useState)(null),
              [H, Z] = (0, x.useState)(!1),
              E = (0, m.a)(),
              N = (0, u.N)(),
              [A, V] = (0, x.useState)(null),
              M = (0, l.SFn)(),
              { lcdUrl: S } = (0, l.U9i)("secret"),
              L = (0, l.xxU)(),
              _ = (0, l.DI5)(),
              { setContractAddress: P, userPreferredGasLimit: O, userPreferredGasPrice: D } = (0, v.F)();
            (0, x.useEffect)(() => {
              (null == n ? void 0 : n.contractAddr) && P(n.contractAddr);
            }, [null == n ? void 0 : n.contractAddr]);
            let F = (0, x.useCallback)(() => {
                C(null), Z(!1), a();
              }, [a]),
              T = (0, x.useCallback)(async () => {
                if ((Z(!0), null == n ? void 0 : n.snip24Enabled)) N(M, n.contractAddr), F(), w();
                else if (k) F(), w();
                else {
                  let { error: e, key: t } = await E(S ?? _.secret.apis.rest ?? "", L ?? "secret-4", M, null == n ? void 0 : n.contractAddr, !1, {
                    gasLimit: O,
                    feeDenom: null == D ? void 0 : D.denom,
                    gasPriceStep: Number((null == D ? void 0 : D.amount) ?? 0)
                  });
                  e ? (V(e), Z(!1)) : (Z(!1), C(t));
                }
              }, [
                ...
                O,
                null == D ? void 0 : D.amount,
                null == D ? void 0 : D.denom
              ]);
            return (0, r.jsx)(s.Z, {
              isOpen: t,
              onClose: F,
              ...
              children: (0, r.jsxs)("div", {
                children: [
                  ...
                  k || (null == n ? void 0 : n.snip24Enabled) ? null : (0, r.jsx)(b.at, { rootDenomsStore: g.gb, rootBalanceStore: h.jZ }),
                  k
                    ? (0, r.jsx)(b.GR, {
                    ...
                    : null,
                  A ? (0, r.jsx)("div", { className: "mb-2", children: (0, r.jsx)(o._, { text: A, disableSentryCapture: !0 }) }) : null,
                  H
                    ? (0, r.jsx)("div", { className: "flex justify-center w-[344px]", children: (0, r.jsx)(c.T, { color: f.w.white100 }) })
                    : (0, r.jsx)(i.Buttons.Generic, {
                        size: "normal",
                        color: "#E18881",
                        className: "w-[344px]",
                        onClick: T,
                        ...
                        children: k
                          ? (0, r.jsx)("span", { "aria-label": "create key sheet confirm button text in snip20 manage tokens flow", children: "Done" })
                          : (0, r.jsx)("span", { "aria-label": "create key sheet confirm button text in snip20 manage tokens flow", children: "Confirm" })
                      })
                ]
              })
            });
          }
          ([m, u, v, h, b] = w.then ? (await w)() : w), n();
        } catch (e) {
          n(e);
        }
      });
      ...
      a.a(e, async function (e, n) {
        try {
          ...
          let m = (0, o.Pi)(e => {
            let { rootDenomsStore: t, rootBalanceStore: a } = e,
              {
                ...
                setGasError: g,
                recommendedGasLimit: h,
                gasError: f
              } = (0, d.F)(),
              y = t.allDenoms,
              v = (0, l.e7)(y),
              [b, w] = (0, c.useState)(!1),
              [j, k] = (0, c.useState)({ option: n, gasPrice: u ?? v.gasPrice }),
              C = (0, c.useCallback)(() => {
                w(!1);
              }, []),
              H = (0, c.useCallback)(e => {
            ...
            return (
              (0, c.useEffect)(() => {
                k({ option: n, gasPrice: v.gasPrice });
              }, [v.gasPrice]),
              (0, c.useEffect)(() => {
              ...
              (0, r.jsx)("div", {
                ...
                children: (0, r.jsxs)(l.ZP, {
                  recommendedGasLimit: h.toString(),
                  gasLimit: (null == o ? void 0 : o.toString()) ?? h.toString(),
                  ...
                  rootDenomsStore: t,
                  children: [
                    (0, r.jsx)(i.a, { setShowFeesSettingSheet: w }),
                    f && !b ? (0, r.jsx)("p", { className: "text-red-300 text-sm font-medium mt-2 text-center", children: f }) : null,
                    (0, r.jsx)(s.k, { showFeesSettingSheet: b, onClose: C, gasError: f })
                  ]
                })
              })
            );
      ...
      a.a(e, async function (e, n) {
        try {
          ...
          var r = a(52322),
            ...
            v = e([d, f, x, y]);
          function b(e) {
            let { isVisible: t, onClose: a, type: n, token: v, onSuccess: b } = e,
              w = (0, u.a)(),
              [j, k] = (0, m.useState)(!1),
              [C, H] = (0, m.useState)(""),
              ...
              L = (0, l.xxU)(),
              _ = (0, m.useRef)(null),
              { setContractAddress: P, userPreferredGasLimit: O, userPreferredGasPrice: D } = (0, f.F)();
            (0, m.useEffect)(() => {
              (null == v ? void 0 : v.contractAddr) && P(v.contractAddr);
            }, [null == v ? void 0 : v.contractAddr]),
              (0, m.useEffect)(() => {
                (null == _ ? void 0 : _.current) && _.current.focus();
              }, [_]);
            let F = (0, m.useCallback)(() => {
                k(!1), E(null), H(""), V(!1), a();
              }, [a]),
              T = (0, m.useCallback)(async () => {
                if (A) b(), F();
                else {
                  k(!0);
                  let e = await N(S ?? "", L ?? "", M, null == v ? void 0 : v.contractAddr, "import" === n, {
                    key: C,
                    gasLimit: O,
                    feeDenom: null == D ? void 0 : D.denom,
                    gasPriceStep: Number((null == D ? void 0 : D.amount) ?? 0)
              ...
              }, [M, L, F, N, C, S, b, A, null == v ? void 0 : v.contractAddr, n, O, null == D ? void 0 : D.amount, null == D ? void 0 : D.denom]);
            return (0, r.jsx)(s.Z, {
              isOpen: t,
              onClose: F,
              ...
              children: (0, r.jsxs)("div", {
                children: [
                  (0, r.jsx)(i.GenericCard, {
                    ...
                    title: null == v ? void 0 : v.symbol,
                    subtitle: null == v ? void 0 : v.name,
                    img: (0, r.jsx)("img", { src: (null == v ? void 0 : v.icon) === "" ? w : null == v ? void 0 : v.icon, className: "w-[40px] h-[40px] mr-4" })
                  }),
                  (0, r.jsx)(i.Input, {
                    onChange: e => {
                      H(e.target.value), E(null);
                    },
                    placeholder: "enter key",
                    className: "mb-4 w-[344px]",
                    ref: _
                  }),
                  "import" === n || A ? null : (0, r.jsx)(y.at, { rootDenomsStore: p.gb, rootBalanceStore: x.jZ }),
                  Z ? (0, r.jsx)("div", { className: "mb-2", children: (0, r.jsx)(o._, { text: Z, disableSentryCapture: !0, className: "mb-4" }) }) : null,
                  A
                    ? (0, r.jsx)(y.GR, {
                        generatedViewingKey: C,
                        onCopy: async () => {
                          h.i.copyText(C);
                        }
                      })
                    : null,
                  j
                    ? (0, r.jsx)("div", { className: "flex justify-center w-[344px]", children: (0, r.jsx)(c.T, { color: g.w.white100 }) })
                    : (0, r.jsx)(i.Buttons.Generic, {
                        size: "normal",
                        color: "#E18881",
                        disabled: !C || !!Z,
                        ...
                        children: A
                          ? (0, r.jsx)("span", { "aria-label": "import key sheet confirm button text in snip20 manage tokens flow", children: "Done" })
                          : (0, r.jsx)("span", { "aria-label": "import key sheet confirm button text in snip20 manage tokens flow", children: "Confirm" })
                      })
                ]
              })
            });
          }
          ([d, f, x, y] = v.then ? (await v)() : v), n();
        } catch (e) {
          n(e);
        }
      });
    ...
    18403: function (e, t, a) {
      a.a(e, async function (e, n) {
        try {
          a.d(t, { GR: () => l.G, LV: () => i.L, at: () => s.a, i3: () => o.i, pt: () => r.p });
          var r = a(31123),
            l = a(61951),
            i = a(89369),
            s = a(91632),
        ...
        try {
          ...
          function w() {
            let e = (0, p.a)(),
              ...
              [a, n] = (0, g.useState)(""),
              [o, b] = (0, g.useState)(!1),
              [w, j] = (0, g.useState)(null),
              [k, C] = (0, g.useState)(!1),
              [H, Z] = (0, g.useState)(!1),
              [E, N] = (0, g.useState)(!1),
              A = (0, m.Z)().get("contractAddress") ?? void 0,
              { secretTokens: V } = (0, l.X0D)(),
              M = e => {
                j(e), b(!0);
              };
            (0, g.useEffect)(() => {
              A && V[A] && (M({ ...V[A], contractAddr: A }), b(!0));
            }, [A, V]);
            let S = (0, g.useMemo)(
                () =>
                  Object.entries(V)
                    .filter(e => {
                      let [t, n] = e,
                        r = a.toUpperCase();
                      return t.toUpperCase().includes(r) || n.name.toUpperCase().includes(r) || n.symbol.toUpperCase().includes(r);
                    })
                    .map(e => {
                      let [t, a] = e;
              ...
              L = (0, g.useCallback)(() => {
                C(!1), Z(!1), N(!1), b(!1), j(null);
              }, []),
              _ = (0, g.useCallback)(() => {
                N(!1), Z(!1);
              }, []),
              P = (0, g.useCallback)(() => L(), [L]),
              O = (0, g.useCallback)(() => C(!1), []);
            return (0, r.jsx)(v.w, {
              children: (0, r.jsxs)("div", {
                className: "relative w-full overflow-clip panel-height",
                children: [
                  (0, r.jsx)(u.Z, {
                    header: (0, r.jsx)(i.Header, { action: { onClick: () => t(-1), type: i.HeaderActionType.BACK }, title: "Manage Tokens" }),
                    children: (0, r.jsxs)("div", {
                      ...
                      children: [
                        (0, r.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, r.jsx)("img", { src: x.r.Misc.Search })
                          ]
                        }),
                        (0, r.jsxs)("div", {
                          ...
                          children: [
                            0 === S.length
                              ? (0, r.jsx)(d.S, {
                                  ...
                                  heading: a ? "No results for “" + (0, f.jr)(a) + "”" : "No Tokens",
                                ...
                                return (0, r.jsxs)(
                                  g.Fragment,
                                  {
                                    children: [
                                      (0, r.jsx)(i.GenericCard, {
                                        onClick: () => M(t),
                                        className: c()({ "rounded-t-2xl": 0 === a, "rounded-b-2xl": l }),
                                        title: t.symbol,
                                        subtitle: t.name,
                                        icon: (0, r.jsx)(s.v, { size: 16, className: "text-gray-400" }),
                                        img: (0, r.jsx)("img", { src: "" === t.icon ? e : t.icon, className: "w-[28px] h-[28px] mr-2" })
                                      }),
                                      l ? null : (0, r.jsx)(i.CardDivider, {})
                                    ]
                                  },
                                  t.contractAddr
                                );
                  ...
                  (0, r.jsx)(y.pt, {
                    isVisible: o,
                    onClose: () => b(!1),
                    onCreateViewingKey: () => C(!0),
                    onUpdateViewingKey: () => Z(!0),
                    onImportViewingKey: () => N(!0),
                    token: w ?? void 0
                  }),
                  (0, r.jsx)(y.LV, { isVisible: k, onClose: O, token: w ?? void 0, onSuccess: P }),
                  (0, r.jsx)(y.i3, { isVisible: E || H, onClose: _, type: E ? "import" : "update", token: w ?? void 0, onSuccess: P })
                ]
              })
            });
          }
          ([v, u, y] = b.then ? (await b)() : b), n();
        } catch (e) {
          n(e);
        }
      });

...
export const buildWalletBalance = (overrides: Partial<WalletBalance> = {}): WalletBalance => ({
  ...
  balanceUACT: faker.number.int({ min: 0, max: 1000000 }),
  totalUAKT: faker.number.int({ min: 0, max: 1000000 }),
  totalUACT: faker.number.int({ min: 0, max: 1000000 }),
  ...
  totalDeploymentEscrowUACT: faker.number.int({ min: 0, max: 100000 }),
  ...
  totalDeploymentGrantsUACT: faker.number.int({ min: 0, max: 100000 }),

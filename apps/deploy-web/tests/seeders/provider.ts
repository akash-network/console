...
export function buildProvider(overrides?: Partial<ApiProviderDetail>): ApiProviderDetail {
  return {
    ...
    attributes: [
      { key: "location-region", value: "na-us-southeast", auditedBy: [faker.string.alphanumeric(42)] },
    ...
    hardwareGpuCapabilities: ["nvidia rtx4000 8Gi pcie"],
    hardwarePersistentStorageClass: "beta3",
    featPersistentStorage: true,
    featShm: true,
    hardwareShm: ["SHM storage class"],
    hardwareCuda: "12.7",

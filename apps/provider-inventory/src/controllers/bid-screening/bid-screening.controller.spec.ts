...
import type { BidScreeningRequest } from "@src/http-schemas/bid-screening.schema";
import type { BidScreeningService } from "@src/services/bid-screening/bid-screening.service";
...
describe(BidScreeningController.name, () => {
  ...
  function setup() {
    ...
    const controller = new BidScreeningController(service);

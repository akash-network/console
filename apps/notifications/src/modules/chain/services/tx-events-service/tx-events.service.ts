...
import { TxData } from "@cosmjs/tendermint-rpc/build/tendermint34/responses";
...
export class TxEventsService {
   ...
   */
  private parseTransactionLog(transaction: TxData): any {
    try {
   ...
   */
  private processAllEventsInTransaction(transactionLogEntries: any[], filter?: EventFilter): ProcessedEvent[] {

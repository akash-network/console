...
export function createReactQueryApiClient(options: CreateAPIQueryClientOptions): APIDefaultQueryClientServices<Services>;
export function createReactQueryApiClient(options: CreateAPIBasicQueryClientOptions): APIBasicQueryClientServices<Services, AllCallbacks>;
export function createReactQueryApiClient(options: CreateAPIBasicClientOptions): APIBasicClientServices<Services, AllCallbacks>;
export function createReactQueryApiClient(): APIUtilityClientServices<Services, AllCallbacks>;
export function createReactQueryApiClient(
